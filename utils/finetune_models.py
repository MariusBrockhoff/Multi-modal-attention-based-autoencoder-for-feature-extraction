...
class PseudoLabel(object):
    ...
    def get_pseudo_labels_NNCLR(self, x, y, pseudo_label_ratio):
        ...
        np.savetxt("C:/Users/marib/Documents/Github/ML_Spike_Sorting/plots/latent_" + str(pseudo_label_ratio) + ".txt", data)
        ...
        np.savetxt("C:/Users/marib/Documents/Github/ML_Spike_Sorting/plots/sel_ind_" + str(pseudo_label_ratio) + ".txt", selected_indices)
    ...
    def finetune_on_pseudos_NNCLR(self, save_Pseudo_dir, input_dim, x, y, x_label_points, y_pred_labelled_points, x_unlabel_points, y_unlabel_points, classification_augmenter):
        ...
        post_dat = self.pseudo.predict(x)
        np.savetxt("C:/Users/marib/Documents/Github/ML_Spike_Sorting/plots/post_dat.txt", post_dat)
    ...
    if finetune_method == "DEC":
        ...
        if finetune_config.ITERATIVE_RATIOS is None:
            ...
            for ratio in finetune_config.ITERATIVE_RATIOS:
                ...
                np.savetxt("C:/Users/marib/Documents/Github/ML_Spike_Sorting/plots/ys_" + str(ratio) + ".txt",
                    ys)


            finetune_config.PSEUDO_SAVE_DIR = finetune_config.PSEUDO_SAVE_DIR #check_filepath_naming(finetune_config.PSEUDO_SAVE_DIR)
            finetuning_model.save_weights(finetune_config.PSEUDO_SAVE_DIR)
            # save labels
            #ys = np.concatenate((y.reshape(len(y), 1), y_pred_finetuned.reshape(len(y_pred_finetuned), 1)), axis=1)
